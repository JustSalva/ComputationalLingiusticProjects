...
def list_compare_relaxed(list1,list2):
    ...
    for num1 in range(len(list1)):
        for num2 in range(len(list2)):
            if list1[num1][1]==list2[num2][1] and ((list1[num1][0] in list2[num2][0]) or (list2[num2][0] in list1[num1][0])) and num1 not in to_not_be_seen_postitions_list1 and num2 not in to_not_be_seen_postitions_list2:
                cnt = cnt + 1
                to_not_be_seen_postitions_list1.append(num1)
                to_not_be_seen_postitions_list2.append(num2)
    return cnt
